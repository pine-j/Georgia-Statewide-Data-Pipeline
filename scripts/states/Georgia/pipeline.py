...
from scripts.states.Georgia.categories.Roadways import RoadwayData

# Future category imports (Phase 2+):
# from scripts.states.Georgia.categories.Bridges import BridgeData
# from scripts.states.Georgia.categories.Safety import SafetyData
# from scripts.states.Georgia.categories.Traffic import TrafficData
# from scripts.states.Georgia.categories.Pavement import PavementData
# from scripts.states.Georgia.categories.Freight import FreightData
