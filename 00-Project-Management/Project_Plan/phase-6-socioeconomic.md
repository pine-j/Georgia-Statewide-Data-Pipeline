# Phase 6 — Socioeconomic (RAPTOR Category — Weight: 0.15)
...
### 6.5 OPB Population Projections (Georgia-specific)
...
### 6.6 Census Population Estimates Program (PEP) 2020-2025
- **Source**: U.S. Census Bureau
...
### 6.7 ACS Commuting & Transportation Tables
- **Source**: U.S. Census Bureau
- **URL**: `https://data.census.gov/`
- **Scope**: Nationwide
...
### 6.8 BLS National Employment Projections (2024-2034)
...
### 6.9 Projections Central — State Long-Term Occupational Projections
...
### 6.10 Georgia DOL Labor Market Explorer
...
**File**: `scripts/states/Georgia/categories/SocioEconomic.py`
...
- `scripts/states/Georgia/categories/SocioEconomic.py`
