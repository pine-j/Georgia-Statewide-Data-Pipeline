# Phase 3 — Safety (RAPTOR Category — Weight: 0.20)
...
### 3.2 FARS Fatal Crashes (Interim/Supplement)
...
### 3.4 GA Governor's Office of Highway Safety — Traffic Data
- **Source**: GA GOHS
...
**File**: `scripts/states/Georgia/categories/Safety/Safety.py`
...
- `scripts/states/Georgia/categories/Safety/Safety.py`
- `scripts/states/Georgia/categories/Safety/Extract_and_Merge.py`
